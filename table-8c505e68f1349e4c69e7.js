...
/***/ function(module, exports, __webpack_require__) {
	...
	function getAnswers(siteId, questionId, answer_filter, page) {
	    return $.get("//api.stackexchange.com/2.2/questions/" + questionId + "/answers?page=" + page + "&pagesize=100&order=desc&sort=activity&site=" + siteId + "&filter=" + answer_filter).then(function (data) {
	        return data.has_more ? getAnswers(siteId, questionId, answer_filter, page + 1).then(function (d) {
	...
	function fillTemplate(sortedItems) {
	    ...
	    $(document.body).html(__webpack_require__(88));
	...
	function execute(SITE_ID, QUESTION_ID) {
	    ...
	    var q = getAnswers(SITE_ID, QUESTION_ID, ANSWER_FILTER, startPage).then(process).then(function (r) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
		...
		__webpack_require__(46) // jQuery.param
