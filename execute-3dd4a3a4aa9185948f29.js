...
/***/ function(module, exports, __webpack_require__) {
	...
	vm.urlChanged.subscribe(function (e) {
	...
	vm.resultFrameLoaded.subscribe(function (e) {
	    var frame = e.target;

	    var script = frame.contentDocument.createElement("script");
	    script.src = __webpack_require__(5).table.localPath;
	...
	ko.computed(function () {
	    ...
	    resultFrame().contentDocument.body.innerHTML = __webpack_require__(9);
	    ...
	    Promise.resolve(executeResult).then(function () {
	        return vm.errorResult(null);
	    }, function (e) {
	        return vm.errorResult(e.responseText || e || "����������� ������");
	    }).then(function () {
	        return vm.executing(false);
	    });
